...
//Add the domain 
const tld=".dev";
const CONTRACT_ADDRESS="0x59Fb0FBaBf413387cA10F402f834B55B0F18ED50";
...
const App = () => {
  ...
  const checkIfWalletIsConnected = async() => {
    ...
    if(accounts.length !== 0){
      ...
      console.log('Found A Account',account);
...
const chainId = await ethereum.request({method:'eth_chainId'});
  ...
  const renderNotConnected = () => (
    <div className ="connect-wallet-container">
      <img src="https://media.giphy.com/media/bGgsc5mWoryfgKBx1u/giphy.gif" alt="Ninja gif" />
